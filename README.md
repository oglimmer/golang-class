...
This repository contains a tutorial for a simple Go REST API.

It teaches you how to implement the Kniffel game as a REST API.

# Requirements

You need basic programming skills in any language, not necessarily in Go.

# Chapter overview

| Chapter  | Topic  | Link  |
|---|---|---|
| 00  | Install Go and an IDE/Editor  | [chapter-00](./chapter-00)  |
| 01  | Base project setup with Go modules  | [chapter-01](./chapter-01)  |
